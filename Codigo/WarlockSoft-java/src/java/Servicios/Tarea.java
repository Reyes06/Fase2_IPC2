...
public class Tarea {
    ...
    public boolean agregarTarea(@WebParam(name = "nombre") String nombre,
                        ...
                        @WebParam(name="tiempoEstimado") int tiempoEstimado,
        ...
        try {
            return c.agregarTarea(nombre, descripcion, diaIni, mesIni, anoIni, precio, tiempoEstimado, cantidadParticipantes, estado, id_usuario, conocimientos);
